# -*- coding: utf-8 -*-
#
# NeuOsc documentation build configuration file, created by
# sphinx-quickstart on Fri Jun 17 16:45:05 2016.
#
...
sys.path.insert(0, os.path.abspath('../../neuosc'))
...
html_theme_options = {
   ...
   'github_repo': 'neupackage',
   'gratipay_user': 'emptymalei',
   'analytics_id': 'UA-66327435-6',
   'description': 'Neutrino Oscillations Packages',
}
...
latex_documents = [
    (master_doc, 'NeuOsc.tex', u'NeuOsc Package Documentation',
     u'Lei Ma', 'manual'),
]
...
man_pages = [
    (master_doc, 'neuosc', u'NeuOsc Package Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NeuOsc', u'NeuOsc Documentation',
     author, 'NeuOsc', 'Neutrino Oscillations Python Package',
     'Miscellaneous'),
]
